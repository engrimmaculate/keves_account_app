...
@section('content')  
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>PETTY CASH BOOK BEGINING</h2>
      <div class="table-responsive py-2">
          ...
          <div class="row g-2">
            <div class="col-md p-2 py-2">
              <form class="form-horizontal" action="{{ route('beginning-balance.update')}}" method="post">
                @csrf
                <div class="form-floating py-2">
                  <input type="text" class="form-control" name="openinning_balance" id="floatingInputGrid" placeholder=" transaction date" value="">
                  <label for="floatingInputGrid">Openinning Balance</label>
                  @if ($errors->has('openinning_balance'))
                      <span class="text-danger">{{ $errors->first('openinning_balance') }}</span>
                  @endif
                </div>
                <div class="form-floating py-2">
                ...
                <div class="form-floating py-2">
                  <input type="text" class="form-control" name="closing_balance" id="floatingInputGrid" placeholder=" transaction date" value="">
                ...
                <div class="form-floating py-2">
                  <input type="text" class="form-control" name="balance" id="floatingInputGrid" placeholder=" transaction date" value="">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="items-center d-flex justify-content-between ml-1">
                        <a href="{{ route('banks.show', $bank->id) }}" class="btn btn-info btn-sm btn-md mb-1">View</a>
                          <a href="{{ route('banks.edit', $bank->id) }}" class="btn btn-warning btn-sm btn-md mb-1">Edit</a>
                          <form action="{{ route('banks.destroy', $bank->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item?')">
                            @csrf
                            @method('DELETE')
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form class="form-horizontal" action="{{ route('banks.store')}}" method="post">
                @csrf
                <div class="form-floating py-2">
                  <input type="text" class="form-control" name="account_no" id="floatingInputGrid" placeholder=" account no " value="">
                ...
                <div class="form-floating py-2">
                  <input type="text" class="form-control" name="amount" id="floatingInputGrid" placeholder=" transaction date" value="">
