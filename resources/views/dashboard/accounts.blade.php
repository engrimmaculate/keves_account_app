...
@section('content') 
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"> Manage Receipts</h1>
      ...
      <div class="row d-flex card py-2 justify-content-around -pb-5 space-x-2 mb-5">
      <div class="col-md-3 col-sm-6  input-group mb-3">
      <span class="input-group-text p-3">Select Date</span>
      <select class="form-select  form-control input-group mb-3 py-3" aria-label="Select-Account">
        ...
        <div class="col-md-3 col-sm-6  input-group mb-3">
        <span class="input-group-text p-3">Select Transaction Date</span>
        <input type="date" class="form-control" placeholder="transaction Date" aria-label="Transaction-Date">
        </div>  
      </div>
      ...
      <div class="col-md-4 col-sm-6 card img-fluid flex-row-reverse py-5 px-2 h-50">
        ...
        <div class="card-img-overlay">
          ...
          <p class="card-text text-success font-bold">BILLING VOUCHERS</p>
      ...
      <div class="col-md p-2">
          <div class="form-floating">
            <select class="form-select" id="floatingSelectGrid">
              ...
              <option value="100">Hotel Booking Account</option>
              <option value="200">Bar and Loundge Account</option>
              <option value="300">Restaurant Account</option>
            </select>
            <label for="floatingSelectGrid">Account Types</label>
          </div>
        
          <div class="form-floating">
            <input type="date" class="form-control" id="floatingInputGrid" name="transaction_date" placeholder="date" value="">
            <label for="floatingInputGrid">Transaction Date</label>
          </div>
        
          <div class="form-floating py-2">
            <input type="amount" class="form-control" id="floatingInputGrid" placeholder="name@example.com" value="">
          ...
          <button type="button" class="btn btn-danger w-100  px-6 py-4">Save Rececipts </button>
        </div>
        </div>
