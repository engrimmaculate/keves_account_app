    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="col-md-3 col-sm-6  card img-fluid flex-row-reverse py-5 px-2 h-50">
        <!-- <img class="card-img-top" src="img_avatar1.png" alt="Card image"> -->
         <span>
            <svg xmlns="http://www.w3.org/2000/svg" height="30" widhth="30"  shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 296.938">
        ...
        <div class="card-img-overlay pb-5">
          ...
          <p class="card-text text-bold text-primary">TOTAL EXPENSES</p>
          <a href="{{ route('expenses.create')}}" class="btn btn-primary mt-2  mb-5">
      ...
      <div class="col-md-4 col-sm-6   card img-fluid flex-row-reverse px-2 py-5 h-50">
        ...
        <div class="card-img-overlay">
          <h4 class="card-title text-2xl text-bold">{{$expCat_count}} </h4>
          <p class="card-text text-bold text-danger">EXPENSE CATEGORY</p>
      ...
      <h2>Add New Expenses (Direct Cost of Sales) </h2>
        ...
        <!-- {{print_r($expenseCategory) }} -->
            ...
            <form method="POST" action="{{ route('expenses.store') }}">
              ...
              <div class="form-floating py-2">
                <input type="date" class="form-control" name="transaction_date" id="floatingInputGrid" placeholder=" transaction date" value="">
              ...
              <div class="form-floating py-2">
                <input type="amount" class="form-control" id="floatingInputGrid" name="amount" placeholder="enter expense amount" value="">
              ...
              <div class="form-floating py-2">
              <input type="text" class="form-control" id="floatingInputGrid" name="description" placeholder="Description " value="">
              ...
              <div class="form-floating py-2">
                <input type="text" class="form-control" id="floatingInputGrid" name="remarks" placeholder="Remarks " value="">
              ...
              <button  type="submit" class="btn btn-danger w-100  px-6 py-4">Save Expenses</button>
              </div>
            </form>
            </div>
          ...
          <table class="table table-striped table-sm text-center">
            <thead>
              <tr>
                ...
                <th scope="col fw-bold text-center" align="center">Business Point</th>
                <th scope="col fw-bold text-center" align="center">amount</th>
                <th scope="col fw-bold text-center" align="center">Expense Category</th>
            ...
            <tr>
                ...
                <td>{{ $expense->account->account_type }}</td>
