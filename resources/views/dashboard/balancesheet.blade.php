      ...
      <div class="table-responsive py-2">
          @if(session('success'))
            ...
            <div class="row g-2 justify-content-center align-items-center ">
              ...
              <div class="col-md-8 p-2 py-2 ml-5">
              <h2 class="text-danger fw-normal">Select Date Range</h2>
              <form class="form-horizontal" action="{{ route('balancesheet.generateReport')}}" method="post">
                  @csrf
                  ...
                  <button type="submit" class="btn btn-danger w-100  px-6 py-4">Generate Balance Sheet Report</button>
                </div>
                  </div>
              </form>
            </div>
