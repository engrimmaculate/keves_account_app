...
@section('content')   
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="col-md-4 col-sm-6   card img-fluid flex-row-reverse px-2 py-5 h-50">
        ...
        <div class="card-img-overlay">
          ...
          <p class="card-text text-bold text-danger">EXPENSES TYPES</p>
  ...
  @endif
      ...
      <div class="col-md p-2 py-2">
        <form class="form-horizontal" action="{{ route('expense-categories.store')}}" method="post">
          @csrf
          ...
          <button type="submit" class="btn btn-danger w-100  px-6 py-4">Save Expense Category</button>
        </div>
        </form>
        </div>
        
        <div class="col-md">
        <h2 class="border-bottom border-bottom-2">All Expense category</h2>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="items-center d-flex justify-content-between ml-1">
                  <a href="{{ route('expense-categories.edit', $expCat->id) }}" class="btn btn-warning btn-sm btn-md mb-1">Edit</a>
