    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="col-md-3 col-sm-6  card img-fluid flex-row-reverse py-5 px-2 h-50">
        ...
        <div class="card-img-overlay">
          <h4 class="card-title">{{$data['exp_count']}}</h4>
          <p class="card-text text-bold text-primary">EXPENSES</p>
      ...
      <div class="col-md-4 col-sm-6   card img-fluid flex-row-reverse px-2 py-5 h-50">
        ...
        <div class="card-img-overlay">
          <h4 class="card-title text-2xl text-bold">{{$data['expCat_count'] }}</h4>
          <p class="card-text text-bold text-danger">EXPENSES CATEGORY</p>
