...
@section('content')  
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>UPDATE PETTY CASH BOOK RECORD</h2>
      <div class="table-responsive py-2">
          ...
          <div class="row g-2">
            <div class="col-md p-2 py-2">
              <form class="form-horizontal" action="{{ route('petty-cash.update',$pettyCash->id)}}" method="post">
                @csrf
                @METHOD("PUT")
                ...
                <div class="form-floating py-2">
                  <input type="text" class="form-control" name="cash_in" id="floatingInputGrid" placeholder=" transaction date" value="{{$pettyCash->cash_in}}">
                ...
                <div class="form-floating py-2">
                  <input type="text" class="form-control" name="cash_out" id="floatingInputGrid" placeholder=" transaction date" value="{{$pettyCash->cash_out}}">
