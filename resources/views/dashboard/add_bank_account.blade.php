    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="col-md p-2">
          ...
          <div class="form-floating">
            ...
            <label for="floatingInputGrid">Revenue Type</label>
          </div>
        
          <div class="form-floating py-2">
            <input type="amount" class="form-control" id="floatingInputGrid" placeholder="name@example.com" value="">
            <label for="floatingInputGrid">Revenue description</label>
          </div>
          ...
          <button type="button" class="btn btn-danger w-100  px-6 py-4"> Save Bank Account </button>
        </div>
        </div>
