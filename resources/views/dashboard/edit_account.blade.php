...
@section('content')   
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="col-md p-2 py-2">
          ...
          <div class="form-floating">
            <select class="form-select" id="floatingSelectGrid" name="narration">
              <option selected>.. Select Narration ..</option>
              <option value="1diesel">Diesel</option>
              <option value="internet">Internet</option>
              <option value="logisttics">Logisttics</option>
              <option value="misc">Miscellaneous</option>
              <option value="salary">Salary</option>
              <option value="repairs">Repairs</option>
            </select>
            <label for="floatingSelectGrid">Select Naration</label>
          </div>
          <div class="form-floating py-2">
          ...
          <div class="form-floating py-2">
            ...
            <label for="floatingSelectGrid">Select Receiver</label>
          </div>
          <div class="form-floating">
