    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="col-md p-2">
          <div class="form-floating py-2">
            <input type="text" class="form-control" id="floatingInputGrid" name="voucher_id" placeholder="Voucher or Receipt Number" value="">
            <label for="floatingInputGrid">Reference / Receipt Number</label>
          </div>
          <div class="form-floating py-2">
          <select class="form-select  form-control input-group mb-3 py-3" aria-label="Select-Account">
              <option selected> ... Income Source ... </option>
          ...
          <div class="form-floating py-2">
            <input type="text" class="form-control" name="amount" id="floatingInputGrid" placeholder="name@example.com" value="">
            <label for="floatingInputGrid">amount</label>
          </div>
          <div class="form-floating py-2">
          <select class="form-select form-control input-group mb-3 py-3" naame="payment_method" aria-label="Select-Account">
          ...
          <div class="form-floating py-2">
            <input type="date" class="form-control" name="transaction_date" id="floatingInputGrid" placeholder="name@example.com" value="">
            <label for="floatingInputGrid">Transaction Date</label>
          </div>
          <div class="form-floating py-2">
    
          <select class="form-select form-control input-group mb-3 py-3" naame="transaction_type" aria-label="Select-Account">
              <option selected> ... Transaction Type ... </option>
              <option value="inflow">In Flow (CR)</option>
          ...
          <div class="form-floating py-2">
            <input type="text" class="form-control" name="period_in_days" id="floatingInputGrid" placeholder="name@example.com" value="">
            <label for="floatingInputGrid">Period in Days</label>
          </div>
          <div class="form-floating py-2">
            <input type="text" class="form-control" name="month_name" id="floatingInputGrid" placeholder="name@example.com" value="">
            <label for="floatingInputGrid">Calender Month</label>
          </div>
          <div class="form-floating py-2">
            <input type="text" class="form-control" name="fiscal_year" id="floatingInputGrid" placeholder="name@example.com" value="">
            <label for="floatingInputGrid">Fiscal Year</label>
          </div>
          <div class="form-floating">
            <input type="text" class="form-control" name="remarks"  id="floatingInputGrid" placeholder="remark" value="">
            <label for="floatingInputGrid">Remarks</label>
          </div>
          <div class="py-4 w-100">
          <button type="button" class="btn btn-danger w-100  px-6 py-4">Save & Post </button>
        </div>
        </div>
