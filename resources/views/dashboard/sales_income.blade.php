    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="col-md p-2">
        ...
        <div class="form-floating">
            <input type="text" class="form-control" id="floatingInputGrid" name="voucher_id" placeholder="Voucher or Receipt Number" value="{{mt_rand(999999, 9999999)}}" readonly>
          ...
          <div class="form-floating py-2">
            <select class="form-select  form-control input-group mb-3 py-3" name="income_stream" aria-label="Select-Account">
                <option > ... Income Source (From ) ... </option>
          ...
          <div class="form-floating py-2">
            <input type="text" class="form-control" name="amount" id="floatingInputGrid" placeholder="Amount" value="">
