      ...
      <div class="row g-2">
        ...
        <div class="col-md p-2 py-2">
          <form class="form-horizontal" action="{{ route('banks.store')}}" method="post">
            ...
            <div class="form-floating py-2">
              <input type="text" class="form-control" name="account_name" id="floatingInputGrid" placeholder=" transaction date" value="">
            ...
            <div class="form-floating py-2">
              <input type="text" class="form-control" name="bank_name" id="floatingInputGrid" placeholder=" transaction date" value="">
            ...
            <div class="form-floating py-2">
              <input type="text" class="form-control" name="bank_branch" id="floatingInputGrid" placeholder=" transaction date" value="">
            ...
            <div class="form-floating py-2">
              <input type="text" class="form-control" name="account_type" id="floatingInputGrid" placeholder=" transaction date" value="">
            ...
            <button type="submit" class="btn btn-danger w-100  px-6 py-4">Store Bank Details</button>
          </div>
          </form>
        </div>
          
        <div class="col-md">
            <h2 class="border-bottom border-bottom-2">All Bank Accounts </h2>
