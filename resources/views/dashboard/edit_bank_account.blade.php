...
@section('content')  
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2 class="text-danger">Update Bank Account Details </h2>
      <a href="{{route('banks.index')}}" class="btn btn-secondary text-2xl">Return Back</a>
      </div>
...
@endif
      ...
      <div class="col-md p-2 py-2">
        <form class="form-horizontal" action="{{ route('banks.update',$bank->id)}}" method="post">
          ...
          <div class="form-floating py-2">
            <input type="text" class="form-control" name="bank_branch" id="floatingInputGrid" placeholder=" transaction date" value="{{$bank->bank_branch}}">
          ...
          <button type="submit" class="btn btn-danger w-100  px-6 py-4">Update Bank Details</button>
        </div>
        </form>
        </div>
        <div class="col-md">
