    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="col-md-3 col-sm-6  card img-fluid flex-row-reverse py-5 px-2 h-50">
        <!-- <img class="card-img-top" src="img_avatar1.png" alt="Card image"> -->
         <span>
            <svg xmlns="http://www.w3.org/2000/svg" height="40" widhth="40"  shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 296.938">
        ...
        <div class="card-img-overlay">
          ...
          <p class="card-text text-bold text-primary">TOTAL INCOME</p>
          <a href="{{url('/add_receipts')}}" class="btn btn-primary mt-2">
          <svg xmlns="http://www.w3.org/2000/svg" height="20" width="30" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 511.99">
      ...
      <div class="col-md-4 col-sm-6   card img-fluid flex-row-reverse px-2 py-5 h-50">
        ...
        <div class="card-img-overlay">
          <h4 class="card-title text-2xl text-bold">{{$totalExpenses}}</h4>
          <p class="card-text text-bold text-danger">TOTAL EXPENSES</p>
      ...
      <div class="col-md-4 col-sm-6 card img-fluid flex-row-reverse py-5 px-2 h-50">
        <!-- <img class="card-img-top" src="img_avatar1.png" alt="Card image"> -->
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96.41 122.88" height="40" widhth="40" class="text-danger">
          <title>bill</title>
        ...
        <div class="card-img-overlay">
          <h4 class="card-title text-bold">{{$totalAccount}}</h4>
          <p class="card-text text-success font-bold">BANK ACCOUNT BANK</p>
      ...
      <h2 class="text-center align-content-center justify-content-center">Transaction History</h2>
      <div class="row g-2">
        ...
        <div class="col-md  py-2">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="">{{$income->voucher_id}}</td>
              <td class="">{{$income->amount}}</td>
              <td class="">{{$income->transaction_type}}</td>
              <td class="">{{$income->payment_method}}</td>
              <td class="py">{!! Str::limit($income->remarks,10) !!}</td>
              <td class="d-flex justify-content-between items-center">
                <a href="{{route('income.show', $income->id)}}" class="btn btn-primary btn-sm">View</a>
        ...
        <div class="col-md">
            ...
            <table class="table table-striped table-sm text-center">
              ...
              <tr>
                  ...
                  <td>{!! Str::limit($expense->remarks,10) !!}</td>
        ...
        <div class="col-md  py-2">
          ...
          <thead>
            <tr>
              ...
              <th scope="col">Last Loggedin</th>
            </tr>
          </thead>
          <tbody>
            @foreach($loggedinUser as $userlogin)
            <tr>
              <td class="">{{$userlogin->id}}</td>
              <td class="">{{$userlogin->user->name}}</td>
              <td class="">{{$userlogin->user_ip}}</td>
              <td class="">{{ Carbon\Carbon::parse($userlogin->created_at)->diffForHumans()}}</td>
              <td class="">{{Carbon\Carbon::parse($userlogin->last_login)->diffForHumans()}}</td>
            </tr>
            @endforeach
          </tbody>
          <tfoot>
