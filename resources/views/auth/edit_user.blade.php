...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="row g-2">
            ...
            <form action="{{ route('users.update',$user->id )}}" method="POST">
                @csrf
                @method('PUT')
                <h1 class="h3 mb-3 fw-bold text-danger">User Update Form</h1>
                ...
                <input type="text" class="form-control" id="floatingInput" name="name" placeholder="name@example.com" value="{{$user->name}}">
                ...
                <button class="w-100 btn btn-lg btn-danger" type="submit">UPDATE USER</button>
