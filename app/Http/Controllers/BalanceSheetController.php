...
class BalanceSheetController extends Controller
{
    ...
    public function index()
    {
        ...
        return  view('dashboard.balancesheet',compact('balanceSheet'));
    }
    ...
    public function generateBalanceSheetReport(Request $request):View
    {
       ...
       return view('dashboard.balance_sheet.balance_sheet_report', compact('petty_reports','data','income_reports','expense_reports'));
